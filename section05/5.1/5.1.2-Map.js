...
//   console.log(`The value at the ${i} position item and it's value says ${thisArr[i]} `);
// }


//   thisArr.forEach((forThisElement, i) => {console.log(`This is the ${i} position and it's value is ${forThisElement}`)})
